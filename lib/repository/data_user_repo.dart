  ...
  Future<void> addDataUserContent(
    ...
    try {
      ...
      final response = await http.post(Uri.parse(
          '${storageUtil.baseURL}/DO/api/tambah_user.php?username=$username&password=$password&nama=$nama&tipe=$tipe&app=$app&gambar=$gambar&wilayah=$wilayah&plant=$plant&dealer=$dealer&online=$online)}'));
