import 'package:doplsnew/models/tampil%20seluruh%20data/do_kurang_all.dart';
import 'package:doplsnew/utils/source/empty_data_source.dart';
import 'package:doplsnew/utils/source/tampil%20seluruh%20data%20source/all_kurang_source.dart';
...
class DoKurangAll extends GetView<DataAllKurangController> {
  const DoKurangAll({super.key});
        ...
        if (controller.isLoadingGlobalHarian.value &&
          ...
          final dataSource = controller.doGlobalHarianModel.isEmpty
              ...
              : DataAllKurangSource(
                  ...
                  onEdited: (DoKurangAllModel model) {
...
class EditDoGlobalData extends StatefulWidget {
  ...
  final DataAllKurangController controller;
  final DoKurangAllModel model;
