...
class DoTambahAll extends GetView<DataAllTambahController> {
  const DoTambahAll({super.key});
        ...
        if (controller.isLoadingGlobalHarian.value &&
          ...
          final dataSource = controller.doGlobalHarianModel.isEmpty ||
              ...
              : DataAllTambahSource(
                  ...
                  onEdited: (DoTambahAllModel model) {
...
class EditDoGlobalData extends StatefulWidget {
  ...
  final DataAllTambahController controller;
  final DoTambahAllModel model;
