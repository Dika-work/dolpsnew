...
class EditDataDOGlobal extends StatefulWidget {
  const EditDataDOGlobal(
      {super.key, required this.controller, required this.model});

  final DataDOGlobalController controller;
  final DoGlobalModel model;

  @override
  State<EditDataDOGlobal> createState() => _EditDataDOGlobalState();
}
