...
class _LaporanSamarindaState extends State<LaporanSamarinda> {
  ...
  // Tambahkan variabel sementara
  String tempSelectedMonth = "";
  ...
  void _updateLaporanSource() {
    setState(() {
      // Update selectedMonth dan selectedYear dengan nilai dari variabel sementara
                ...
                for (int i = 0; i < 12; i++)
                  GridColumn(
                    ...
                    label: Container(
                      ...
                      child: Text(
                        months[i], // Menampilkan nama bulan (Jan, Feb, dst.)
                        style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                              fontWeight: FontWeight.bold,
                              color: (i == months.indexOf(selectedMonth))
                                  ? Colors.red
                                  : Colors.black,
                            ),
                      ),
