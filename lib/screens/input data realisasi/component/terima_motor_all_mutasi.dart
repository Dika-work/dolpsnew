...
class TerimaMotorAllMutasi extends StatefulWidget {
  const TerimaMotorAllMutasi({super.key, required this.model});

  final DoRealisasiModel model;

  @override
  State<TerimaMotorAllMutasi> createState() => _TerimaMotorAllMutasiState();
}

class _TerimaMotorAllMutasiState extends State<TerimaMotorAllMutasi> {
  late int id;
  late String tujuan;
  late String plant;
  late int type;
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () => controller.simpanAllDataMutasi(id),
                style: ElevatedButton.styleFrom(
                  padding: const EdgeInsets.symmetric(
                      vertical: 20.0, horizontal: 25.0),
                ),
